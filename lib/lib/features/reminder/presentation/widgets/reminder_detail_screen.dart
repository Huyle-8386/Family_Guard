  ...
  Widget _buildHeader() {
    return Container(
      ...
      decoration: const BoxDecoration(
        color: Colors.white,
        border: Border(
          bottom: BorderSide(color: Color(0x1900ACB2), width: 1),
        ),
      ),
      child: SafeArea(
        bottom: false,
  ...
  Widget _buildBottomBar() {
    return Container(
      ...
      decoration: const BoxDecoration(
        color: Colors.white,
        border: Border(
          top: BorderSide(color: Color(0x1900ACB2), width: 1),
        ),
      ),
      child: SafeArea(
        top: false,
      ...
      builder: (context, child) {
        return Theme(
          data: Theme.of(context).copyWith(
            colorScheme: const ColorScheme.light(primary: Color(0xFF00ACB2)),
          ),
          child: child!,
        );
      },
