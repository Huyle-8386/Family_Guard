...
class _MemberScreenState extends State<MemberScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    const Color mintColor = Color(0xFF8DE8DE);
    const Color hintTextColor = Color(0xFF4A746F); // Màu xanh đậm đặc trưng của text
    const Color iconColor = Color(0xFF1B1B1B);
    return Scaffold(
      ...
      const Icon(
          ...
          Expanded(
            child: Container(
              height: 40, // Độ cao chuẩn để tạo dáng thuôn dài
