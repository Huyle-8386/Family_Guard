...
import 'package:family_guard/features/family_guard/presentation/screens/family_guard_screen.dart';
...
class HomePage extends StatelessWidget {
  ...
  static final List<_QuickActionData> _quickActions = [
    _QuickActionData(
      ...
      onTapRouteName: AppRoutes.memberManagement,
    ),
    _QuickActionData(
      title: 'Tâm trạng',
    ...
    _QuickActionData(
      ...
      builder: _buildFamilyGuardScreen,
    ),
    _QuickActionData(
      title: 'Nhịp tim',
  ...
  static Widget _buildFamilyGuardScreen() => const FamilyGuardScreen();
